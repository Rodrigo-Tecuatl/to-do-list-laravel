...
return [
    ...
    | reglas de tamaño. Siéntete libre de modificar estos mensajes según sea necesario.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para intercambiar los nombres de los campos
    | por otros más legibles en los mensajes de error.
    |
    */
